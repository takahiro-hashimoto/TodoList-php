  ...
  $("#js-button-add").click(function(){
    ...
    if($inputTask.val() === ''){
      ...
      $.post('add.php',{title:title},function(rs){
        var itemStr = $('<div id="js-itemList-'+rs+'"data-id="'+rs+'" class="ui segment itemList-item"><span></span> <button class="edit ui button">編集</button><button class="delete ui button">完了</button></div>');
